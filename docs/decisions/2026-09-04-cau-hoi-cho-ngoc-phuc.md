...
**Bằng chứng đầy đủ:** `docs/reviews/2026-09-04-technical-review.md` — đọc **Phụ lục J** trước (sổ tổng hợp), chi tiết ở D–I
...
**1. Mọi con số dưới đây đo được trên code và artifact thật**, có lệnh tái tạo ở `docs/reviews/2026-09-04-technical-review.md`
Phụ lục C. Không có số nào là ước lượng hay ngoại suy trừ khi ghi rõ.

**2. Không mục nào đã bị tự ý thay đổi.** Theo `docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` A5 — *"Gói nháp không kích hoạt
...
`docs/reviews/2026-09-04-technical-review.md` J.5. Tài liệu này dùng con số **sau đính chính**.
...
1. Có đồng ý rằng equal-weight 1/30 **không đại diện** cho persona ở `docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` A1
   (*"nhà đầu tư cá nhân có danh mục cổ phiếu hiện hữu"*)?
2. Evidence run nên dùng danh mục nào trong lúc chờ danh mục thật có consent (`docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` G2)?
...
`docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` §7 ghi rõ *"chưa có investor portfolio thật"*. Kết luận ở đây là **định hướng về cơ
...
|---|---|---|
| **(a)** | Tăng số mẫu (`docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` D8: *"sample count scale theo số hệ số"*) | **Không giải quyết được.** Vấn đề là lớp mô hình, không phải số mẫu: bậc 2 không biểu diễn nổi hàm CVaR ở vùng nhiều hành động |
...
`docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` D5 đề xuất hàm mục tiêu **lexicographic** (theo thứ tự ưu tiên). Code thực tế
...
1. Giữ tổng có trọng số, và **xoá khoá `priority`** để khỏi gây hiểu nhầm? Hay implement
   lexicographic thật?
2. Nếu giữ tổng có trọng số: `docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` D5 yêu cầu *"Weights/scales của QUBO phải fit trên
...
## B1. `docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` có được ký không?

Toàn bộ `docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` mang `DRAFT_PENDING_NGOC_REVIEW` — dòng 5 ghi *"không phải biên bản đã ký"*,
...
`docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` yêu cầu tạo, hiện **không có tệp nào**:
...
### Số đo (đây chính là dry-run mà `docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` E3 yêu cầu)
...
`docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` E3 ghi rõ các số ngân sách này là *"Draft… cần dry-run, không cam kết SLA"*.
...
`docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` G3: *"Ngọc ký final trên run/config hash cụ thể."*
