# Đề xuất cho Phúc/Ngọc duyệt — instance có ràng buộc ghép (CHƯA CHẠY)

Trạng thái: `DRAFT_PENDING_RISK_PRODUCT_APPROVAL` · Ngày: 2026-09-13

> Ghi chú 2026-09-17: soạn khi còn gọi là "protocol v4". `hybrid_v4.yaml` hiện là lần chạy lại v3 trên
> dữ liệu FiinPro — đề xuất này nếu được duyệt sẽ dùng experiment_id mới (v5 trở đi).
