...
cho tới Gate H4.
Nguồn: `docs/hybrid/2026-09-13-phuong-an-quantum-assisted.md` + quyết định của Ngọc (13/09/2026).
...
- [ ] Tìm commit/branch/script/notebook đã sinh 1,11% / 4,79% / 5,84% (không nằm ở `workflow.py` hiện tại —
      xem C2). Ghi vào `docs/hybrid/2026-09-13-provenance-exploratory.md`: commit, lệnh, config, 5 portfolio
