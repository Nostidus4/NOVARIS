...
> **ARCHIVED (2026-08-07).** Superseded bởi
> [`docs/architecture/ai-decisions-v0.2.md`](../architecture/ai-decisions-v0.2.md).
> Giữ file này chỉ để truy vết thảo luận; không dùng làm nguồn hiện hành.

**Status:** ARCHIVED — was DRAFT discussion record; not an Approved Decision Log or Config Registry.
