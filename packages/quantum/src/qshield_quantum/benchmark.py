...
biện minh được — `docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` câu hỏi 5). Cần có để CLAUDE.md quy tắc 18 ("QAOA thua exact hay thua
...
def coordinate_descent_classical(
    ...
    *,
    ...
    (docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md E4 yêu cầu ablation với ngân sách BẰNG NHAU).
