...
"""QAOA p=1 thường (KHÔNG warm-start ở lần đầu — `docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md` câu hỏi 2: `solvers/warm_start.py` là
...
def solve_qaoa_one_seed(
    ...
    *,
    ...
    # `qubo_hash` — ký duyệt trên một run hash cụ thể (docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md G3) sẽ là ký vào con số không
    # dựng lại được.
    #
