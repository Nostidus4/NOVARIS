...
def scenarios(
    ...
    # capability" (docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md R04). Ưu tiên: FAIL > INCOMPLETE > WARN > PASS — vi phạm cấu trúc/phân
    ...
    # (docs/decisions/2026-08-31-phan-hoi-bao-cao-15-08.md §5). Đây là DIAGNOSTIC THUẦN TUÝ — không bao giờ chạm vào `status`: ngưỡng
